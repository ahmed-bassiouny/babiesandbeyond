...
public class PayFortPayment {
    ...
    //Statics
    private final static String MERCHANT_IDENTIFIER ="NWupHCkh"; //"Use your registered merchant identifier";//"NWupHCkh";//;
    private final static String ACCESS_CODE = "lurbWYO7xSy0rp8Fzncd";//"Use your registered access code which is generated at the time of regitration at payfort";//"zx0IPmPy5jp1vAz8Kpg7";//;
